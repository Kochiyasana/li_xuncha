...
public class TianJiaXunChaActivity extends AppCompatActivity implements FreshImgCallBack {
    ...
    private FreshImgCallBack context1;
    ...
    private Map<String, ArrayList<String>> map = new ArrayMap<String, ArrayList<String>>();
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Toast.makeText(TianJiaXunChaActivity.this, "上传成功", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = TianJiaXunChaActivity.this;
        initFresco();
        initViews();
    ...
    public void initViews() {
        ...
        setContentView(R.layout.activity_tian_jia_xun_cha);
        ...
        imageView = findViewById(R.id.dropview_image);
        ...
        editText_xuesheng = findViewById(R.id.xuesheng_et);
        editText_jiaoshi = findViewById(R.id.jiaoshi_et);
        teacher_name = findViewById(R.id.jiaoshi_autotextView);
        ...
        banji_name = findViewById(R.id.banji_autotextView);
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            arrayAdapter = new ArrayAdapter<String>(TianJiaXunChaActivity.this, android.R.layout.simple_list_item_1, list);
        ...
        course_name = findViewById(R.id.kecheng_autotextView);
                        ...
                        public void run() {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    arrayAdapter = new ArrayAdapter<String>(TianJiaXunChaActivity.this, android.R.layout.simple_list_item_1, list1);
...
//            }
//        });
        textView = findViewById(R.id.tijiao);
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (teacher_name.getText() == null || teacher_name.getText().toString().isEmpty()) {
                    Toast.makeText(TianJiaXunChaActivity.this, "请填写教师名", Toast.LENGTH_SHORT).show();
                } else if (course_name.getText() == null || course_name.getText().toString().isEmpty()) {
                    Toast.makeText(TianJiaXunChaActivity.this, "请填写课程名", Toast.LENGTH_SHORT).show();
                } else if (banji_name.getText() == null || banji_name.getText().toString().isEmpty()) {
                    Toast.makeText(TianJiaXunChaActivity.this, "请填写班级名", Toast.LENGTH_SHORT).show();
                } else if (name == null || name.isEmpty()) {
                    Toast.makeText(TianJiaXunChaActivity.this, "请选择所在教室", Toast.LENGTH_SHORT).show();
                } else if (editText_jiaoshi.getText() == null || editText_jiaoshi.getText().toString().isEmpty()) {
                    Toast.makeText(TianJiaXunChaActivity.this, "请填写教师状态", Toast.LENGTH_SHORT).show();
                } else if (course_name.getText() == null || course_name.getText().toString().isEmpty()) {
                    Toast.makeText(TianJiaXunChaActivity.this, "请填写学生状态", Toast.LENGTH_SHORT).show();
                } else {
                    LianJieWangLuo tj = new LianJieWangLuo(useId, teacher_name.getText().toString(), course_name.getText().toString(), banji_name.getText().toString(), name, editText_jiaoshi.getText().toString(), editText_xuesheng.getText().toString(), imgList);
                    tj.start();
                    UIHelper.showDialogForLoading(TianJiaXunChaActivity.this, "正在上传，请稍后。");
                }
            }
        });
        setMap();
        ...
        imageView = findViewById(R.id.dropview_image1);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
        ...
        tv = findViewById(R.id.jiaoxuelou);
        ...
        adapter = new ImgGridAdapter(TianJiaXunChaActivity.this, imgList, maxImgSize, this);
...
//        }
   ...
   */
    ...
    private void initWheel1(View view) {
        ...
        mainWheelView.setWheelAdapter(new ArrayWheelAdapter(context));  //设置滚轮数据适配器s
        ...
        childWheelView.setWheelAdapter(new ArrayWheelAdapter(TianJiaXunChaActivity.this));
...
//                .statusBarColor(ContextCompat.getColor(this, R.color.colorPrimaryDark))
    ...
    private void showPopwindow(ArrayList<String> list1, final int layout_id) {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (layout_id) {
                    case R.id.dropview_image:
                        ...
                        editText_xuesheng.setSelection(editText_xuesheng.getText().length()-2);
                        window.dismiss();
                        break;
                    case R.id.dropview_image1:
                        editText_jiaoshi.setText(editText_jiaoshi.getText().toString() + xiaoxi);
                        editText_jiaoshi.requestFocus();
                        editText_jiaoshi.setSelection(editText_jiaoshi.getText().length());
                        window.dismiss();
                        break;
                }
        ...
        window.showAsDropDown(TianJiaXunChaActivity.this.findViewById(layout_id));
        //popWindow消失监听方法
...
//         在底部显示
        window.showAtLocation(TianJiaXunChaActivity.this.findViewById(R.id.dropview_image),
                Gravity.BOTTOM, 0, 70);

        window.showAsDropDown(TianJiaXunChaActivity.this.findViewById(R.id.jiaoxuelou));
        //popWindow消失监听方法
        window.setOnDismissListener(new PopupWindow.OnDismissListener() {
    ...
    private void setMap() {
        ...
        KuaiJieDatabase kuaiJieDatabase = new KuaiJieDatabase(TianJiaXunChaActivity.this, "KuaiJieDatabase.db", null, 2);
