...
public class ChartItemActivity extends Activity {
    ...
    public void initView() {
        ...
        tv = findViewById(R.id.tv_zhineng);
        List<Entry> entryList = new ArrayList<>();
        switch (flag) {
            case -1:
                Toast.makeText(ChartItemActivity.this, "传值错误", Toast.LENGTH_LONG).show();
                finish();
                break;
            case 1:
                teacher();
        ...
        lineChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                intent1.setClass(ChartItemActivity.this, ChartBaritemActivity.class);
