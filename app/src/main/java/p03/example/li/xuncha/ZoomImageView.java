...
public class ZoomImageView extends View {
    ...
    /**
        ...
        public void fin(Activity activity){
...
//            System.out.println("xxxx: " + translateX + "yyyyyy: " + translateY + "asadyyyyy" +totalTranslateY );
//            if (translateX <= 6 && translateY <= 726.1 && translateY >= 725 && dian){
