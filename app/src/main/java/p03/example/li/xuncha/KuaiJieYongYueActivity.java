...
public class KuaiJieYongYueActivity extends AppCompatActivity {
    ...
    private KuaiJieYongYueAdapt mAdapter, mAdapter1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor.close();
        mAdapter = new KuaiJieYongYueAdapt(this, mDatas);
        mAdapter1 = new KuaiJieYongYueAdapt(this, mDatass);
        mRv_jiaoshi.setAdapter(mAdapter);
        mRv1_xuesheng.setAdapter(mAdapter1);
        ItemTouchHelper.Callback callback = new RenRenCallback(mRv_jiaoshi, mAdapter, mDatas);
        ...
        mAdapter.setOnItemDeleteClickListener(new KuaiJieYongYueAdapt.onItemDeleteListener() {
            @Override
            public void onDeleteClick(int i) {
                //每个最上面的数据都是列表中第 0 个
                db.delete("KuaiJieDatabase","id=?",new String[]{mDatas.get(0).get("id")});
                mDatas.remove(0);
        ...
        mAdapter.setonItemUseListener(new KuaiJieYongYueAdapt.onItemUseListener() {
            @Override
            public void onUseClick(int i) {
                ...
                db.update("KuaiJieDatabase", values, "id=?",new String[]{mDatas.get(0).get("id")});
                Toast toast;
